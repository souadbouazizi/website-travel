    ...
    <div className='recommended-section'>
        <Container className='position-relative py-5 rounded'>
            ...
            <div className='row justify-content-end'>
                ...
                >{props.itemRecommendedTitle}</h3>
                <p className='text-light'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Dignissimos laborum odio repellendus! Hic ratione ut, iste omnis qui nihil minima.</p>
